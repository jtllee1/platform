  ...
  function ballMovement() {
    ...
    if (gameState.innerText == "On") {
      ...
      if (direction == "N") {
        ...
        if (nW.classList.contains("obstacle")) {
        ...
        if (nE.classList.contains("obstacle")) {
        ...
        if (sW.classList.contains("obstacle")) {
        ...
        if (sE.classList.contains("obstacle")) {
        ...
        else if (sE.classList.contains("right-boundary") && document.getElementById(parseInt(sE.id) + 30).classList.contains("active")) {
          direction = "NW";
        }
